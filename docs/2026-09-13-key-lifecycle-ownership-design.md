...
**Status:** under implementation. **S1a implemented and merged** 2026-09-14 (tdns #650 → 2af063dc, tdns-mp #66 → f11db7a). **S1b implemented and merged** 2026-09-14 (tdns #656 → b37e32ab, tdns-mp #67 → 5f8f906), as Amendment 1 describes it. **S2 implemented and merged** 2026-09-15 (tdns #659 → 49df2c3a; nothing registers an owner yet, and tdns-mp re-pins with S3). S3–S6 not started. The Status column of the §6 table is kept current; the design text is not rewritten after implementation (dated amendments at the end).
