...
var lgHandler = tdns.Logger("handler")
...
func chunkQueryHandler(ctx context.Context, req *tdns.DnsQueryRequest, store ChunkPayloadStore) error {
...
func serveChunkRR(req *tdns.DnsQueryRequest, qname string, chunk *core.CHUNK) error {
