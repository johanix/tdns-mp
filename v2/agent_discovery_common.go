 ...
 *
 * MP-specific DNS lookup helpers for agent discovery.
 * These methods use the IMR engine to look up agent contact information and keys.
 * Migrated from tdns/v2/legacy_agent_discovery_common.go.
 */
