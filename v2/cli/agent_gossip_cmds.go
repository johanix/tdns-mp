...
// --- Shared display functions used by both agent and auditor gossip commands ---

func printGossipGroupList(amr *tdns.AgentMgmtResponse) {
	...
	for _, g := range groups {
		...
		fmt.Printf("%-12s %-40s %s\n", name, strings.Join(memberStrs, ", "), zonesStr)
	}
}

func printGossipGroupState(amr *tdns.AgentMgmtResponse) {
