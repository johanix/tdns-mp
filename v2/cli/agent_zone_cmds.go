...
var agentZoneBumpCmd = &cobra.Command{
	Use:   "bump",
	Short: "Bump the SOA serial of an agent-served zone",
	Run:   func(cmd *cobra.Command, args []string) { tdnscli.RunZoneBump("agent", args) },
}
...
func init() {
	...
	tdnscli.AgentZoneCmd.AddCommand(agentZoneBumpCmd)
